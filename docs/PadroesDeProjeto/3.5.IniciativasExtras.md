...
![Melhoria do Diagrama UML](docs/PadroesDeProjeto/_media/Diagrama/DiagramaUML2.png)
...
### Diagrama de Comunicação
 ...
 ![Diagrama de Comunicação](docs/PadroesDeProjeto/_media/Diagrama/DiagramadeComunicação.png)
